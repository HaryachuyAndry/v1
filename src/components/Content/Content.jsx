...
const Content = props => (
  <div className={ContentStyle.Content}>
    <Route path="/climate" exact render={() => <ImgRoom bgUrl="climate_room.png" />} />
    ...
    <Route path="/charts" exact render={() => <ImgRoom bgUrl="charts.png" />} />
    <Route path="/scenery" exact render={() => <ImgRoom bgUrl="scenario.png" />} />
    <Route path="/security" exact render={() => <ImgRoom bgUrl="security.png" />} />
